...
function parse_commandline()
    ...
    @add_arg_table s begin
        ...
        #     arg_type = Int
        #     default = 5_000
        #     help = "(Defaults to 5_000). Number of Markov chains to run in parallel."
        # "--target"
        #     arg_type = Float64
        #     default = 0.95
        #     help = "(Defaults to 0.95). Pearson correlation coefficient on the two-points statistics to be reached."
        ...
        #     arg_type = Int
        #     default = 1
        #     help = "(Defaults to 1). Number of models to save during the training."
        # "--nthreads"
        #     arg_type = Int
        #     default = 1
        #     help = "(Defaults to 1). Number of threads used."
        ...
        #     arg_type = Float64
        #     default = 0.001
        #     help = "(Defaults to 100). Number of coulings activatedat each epoch."
        # "--convergence"
        #     default = false
        ...
        #     arg_type = String
        #     default = "gibbs"
        #     help = "sampler can be both: metropolis or gibbs"
    end
    return parse_args(s)
end
...
function main(args)
    ...
    println("\n"); flush(stdout)
    eaDCAsrc.fit(args["data"], args["alphabet"], args["weights"], args["nchains"], args["factivate"],args["pseudocount"], args["lr"], args["nepochs"], args["nsweeps"], args["gsteps"], args["output"], args["target"], args["path_params"], args["path_chains"], args["label"], args["sampler"], args["seed"])
end
